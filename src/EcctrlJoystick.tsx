...
const JoystickComponents = (props: EcctrlJoystickProps) => {
  ...
  useEffect(() => {
    ...
    joystickDiv.addEventListener("touchmove", onTouchMove as EventListener, {
      passive: false,
    });
    joystickDiv.addEventListener("touchend", onTouchEnd as EventListener);
    ...
    return () => {
      ...
      joystickDiv.removeEventListener("touchend", onTouchEnd as EventListener);
